...
class PostController extends Controller
{
    ...
    public function view($post_id)
    {
        ...
        return view('posts.view', ['posts' => $posts, 'categories' => $categories,
            'likeCtr' => $likeCtr,
            'dislikeCtr' => $dislikeCtr, 'comments' => $comments
        ]);
    ...
    public function edit($post_id)
    {
        ...
        return view('posts.edit', ['posts' => $posts, 'categories' => $categories,
            'category' => $category]);
    }
    ...
    public function editPost(Request $request, $post_id)
    {
        ...
        return redirect('/home')
            ->with('response', 'Post Updates Successfully');
    ...
    public function category($cat_id)
    {
        ...
        $posts = DB::table('posts')
            ...
            ->paginate(5);
        return view('categories.categories_posts', ['categories' => $categories,
            'posts' => $posts
        ]);
    }
    ...
    {
        $loggedin_user = Auth::user()->id;
        $like_user = Dislike::where(['user_id' => $loggedin_user, 'post_id' => $id])
            ->first();
        if (empty($like_user->user_id)) {
            $user_id = Auth::user()->id;
            $email = Auth::user()->email;
